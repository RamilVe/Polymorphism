...
namespace Task2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var ph3 = new Phone { Name = "Iphone 12", Price = 2000, Camera = 4, SimCount = 1 };
                    ...
                    case "2":
                        ...
                        for (int i = 0; i < products.Length; i++)
                        {
                            if (products[i] is Notebook)
                            {
                                ...
                                Console.WriteLine(products[i].Name + " - " + products[i].Price+" "+nt.RAM);
                            }
                        }
                        break;
                    case "3":
